...
import { authWarn, toggle } from '@/store/features/cart/cartSlice'
    ...
    return (
        <DialogDemo open={openDialog} setOpen={() => ("")} customClass={" w-fit min-w-[300px] w-[clamp(320px,26.67vw,512px)] z-[99992]"}>
            <div className="mx-auto flex flex-col gap-clamp-24 relative p-clamp-48 ">
                {/* close icon  */}
                <button onClick={handleLogin} className="absolute top-0 p-clamp-10 bg-wd500 right-clamp-20 bg-wd500 -translate-y-[50%] cursor-pointer">
