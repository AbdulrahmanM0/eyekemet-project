...
function Description({ details, product }) {
    const { handleAddToCart, setSelectedOptions , selectedOptions,loading } = useProduct();
    ...
    return (
        <div className='flex flex-col gap-clamp-30 3xl:gap-clamp-42'>
            ...
            {/* Ring Size */}
           <Modifiers details={details} setSelectedOptions={setSelectedOptions} selectedOptions={selectedOptions}/>
